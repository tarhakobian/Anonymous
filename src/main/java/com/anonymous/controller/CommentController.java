...
import com.anonymous.service.CommentService;
...
public class CommentController {
    ...
    public ResponseEntity<?> deleteComment(@PathVariable @Positive Integer commentId) {
    ...
    public ResponseEntity<?> edit(@PathVariable @Positive Integer commentId, @NotNull @RequestParam String content) {
    ...
    public ResponseEntity<?> like(@PathVariable @Positive Integer commentId) {
    ...
    public ResponseEntity<?> unlike(@PathVariable @Positive Integer commentId) {
